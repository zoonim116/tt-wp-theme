				...
				<ul>
					...
					<li>
						...
						<div class="navbar-end-menu__sub-cart">
							...
							<div class="sub-cart__list">
								<div class="sub-cart__item">
									<a href="#" class="sub-cart__prod-img">
										<img  src="" alt="">
									</a>
									<div class="sub-cart__prod-info">
										<a href="#" class="sub-cart__prod-name">L90X6 / 90X6 רבגמ</a>
										<div class="sub-cart__prod-price">₪1 670</div>
									</div>
									<a class="sub-cart__delete">
							...
							<div class="sub-cart__footer">
								<div class="sub-cart__footer-header">
									...
									<div class="sub-cart__footer-price" >₪5 070</div>
								</div>
								<div class="sub-cart__footer-button">
									<button class="btn btn-white">הלגעל ףסוה</button>
									<button class="btn btn-blue button">םלשל</button>
								</div>
							</div>
						</div>
					</li>
