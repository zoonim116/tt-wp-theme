...
<section class="home-category">
        ...
        <div class="home-category-item">
            <div class="container">
                <div class="home-category-item-header">
                    ...
                    <?php $child_terms_ids = wp_list_pluck($child_categories[$parent_category->term_id][0],'term_id'); ?>

                    <div class="btn-group">
                        <a href="#" class="btn">תקנות ומכשירים בעבור לקויי שמיעה</a>
                        <a href="#" class="btn">קופסת עיתונאים</a>
                        <a href="#" class="btn">מערכות קשר במה ואולפן</a>
                        <a href="#" class="btn">קופסאות חיבור ישיר - ID</a>
                    </div>
                </div>
                <div class="home-category-products-slider">
                    <div class="catalog-products-list catalog-all-list" id="catalog-products-list-1">
                        <div class="catalog-products-item">
                            <div class="item-wrap">
                                <div class="item-info">
                                    <p class="title"><a href="#">CRU-7 / CRU-7A </a></p>
                                    <div class="count">
                                        <span>5</span>
    ...
    <div class="home-category-item">
        <div class="container">
            <div class="home-category-item-header">
                <div class="home-category-item-header-img">
                    <img src="<?php echo get_template_directory_uri(); ?>/images/catalog-header1.jpg">
                </div>
                <h4><a href="#">ציוד JD</a></h4>
                <div class="btn-group">
                    <a href="#" class="btn">תקנות ומכשירים בעבור לקויי שמיעה</a>
                    <a href="#" class="btn">קופסת עיתונאים</a>
                    <a href="#" class="btn">מערכות קשר במה ואולפן</a>
    ...
    <div class="home-category-item">
        <div class="container">
            <div class="home-category-item-header">
                <div class="home-category-item-header-img">
                    <img src="images/catalog-header1.jpg">
                </div>
                <h4><a href="#">ציוד JD</a></h4>
                <div class="btn-group">
                    <a href="#" class="btn">תקנות ומכשירים בעבור לקויי שמיעה</a>
